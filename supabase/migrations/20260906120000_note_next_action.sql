...
-- activity, `reminder_date` when it is due. Both are nullable: a note
...
alter table "public"."contact_notes" add column "reminder_date" timestamp with time zone;

alter table "public"."deal_notes" add column "next_action" text;

alter table "public"."deal_notes" add column "reminder_date" timestamp with time zone;
