  ...
  resources: {
    ...
    contacts: {
      ...
      import: {
        ...
        description:
          "Choisissez un fichier CSV, vérifiez l'aperçu, associez vos colonnes, puis importez vos contacts.",
        ...
        mapping_title: "Choisissez la destination de chaque colonne",
        mapping_hint:
          "Nous avons associé les colonnes reconnues. Corrigez celles qui pointent vers le mauvais champ et laissez de côté celles dont vous n'avez pas besoin.",
        mapping_column: "Colonne de votre fichier",
        mapping_sample: "Première valeur",
        mapping_field: "Importer comme",
        mapping_ignore: "Ne pas importer",
        mapping_select_label: "Importer la colonne %{header} comme",
        mapping_missing:
        ...
        fields: {
          first_name: "Prénom",
          last_name: "Nom",
          email_work: "E-mail professionnel",
          email_home: "E-mail personnel",
          email_other: "Autre e-mail",
          phone_work: "Téléphone professionnel",
          phone_home: "Téléphone personnel",
          ...
          linkedin_url: "URL LinkedIn",
          avatar: "Avatar",
          has_newsletter: "Inscrit à la newsletter",
        ...
        progress:
          "%{importCount} contacts importés sur %{rowCount}, avec %{errorCount} erreurs.",
        error:
          "Ce fichier n'a pas pu être importé. Vérifiez qu'il s'agit d'un fichier CSV valide avec une ligne d'en-tête, puis relancez l'import.",
        imported: "Importé",
