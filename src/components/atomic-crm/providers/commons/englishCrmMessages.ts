  ...
  resources: {
    ...
    contacts: {
      ...
      import: {
        ...
        description:
          "Upload a CSV file, check the preview, match your columns, then import your contacts.",
        button: "Import CSV",
        start: "Start import",
        back: "Back",
        next: "Continue",
        ...
        mapping_title: "Choose where each column goes",
        mapping_hint:
          "We matched the columns we recognised. Change the ones that went to the wrong field, and leave out the ones you do not need.",
        mapping_column: "Column in your file",
        mapping_sample: "First value",
        mapping_field: "Import as",
        mapping_ignore: "Do not import",
        mapping_select_label: "Import the %{header} column as",
        mapping_missing:
